...
///             all physical memory into the kernel page table.
//----------------------------------------------------------------------------
void
kmem_init();

//----------------------------------------------------------------------------
//  @function   kmem_pagetable
/// @brief      Return the kernel page table data structure.
/// @returns    A pointer to the kernel's page table.
//----------------------------------------------------------------------------
pagetable_t *
kmem_pagetable();
